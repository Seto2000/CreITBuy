...
namespace CreITBuy.Infrastructures.Migrations
{
    ...
    [Migration("20220411150314_JobRequestFix")]
    partial class JobRequestFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CreITBuy.Infrastructure.Data.Models.UserJobRequest", b =>
                {
                    ...
                    b.Property<string>("JobRequestId1")
                        .HasColumnType("nvarchar(36)");
                    ...
                    b.HasIndex("JobRequestId1")
                        .IsUnique()
                        .HasFilter("[JobRequestId1] IS NOT NULL");
            ...
            modelBuilder.Entity("CreITBuy.Infrastructure.Data.Models.UserJobRequest", b =>
                {
                    ...
                    b.HasOne("CreITBuy.Infrastructure.Data.Models.JobRequest", null)
                        .WithOne("FromUserJobRequest")
                        .HasForeignKey("CreITBuy.Infrastructure.Data.Models.UserJobRequest", "JobRequestId1");
            ...
            modelBuilder.Entity("CreITBuy.Infrastructure.Data.Models.JobRequest", b =>
                {
                    b.Navigation("FromUserJobRequest");
                });
